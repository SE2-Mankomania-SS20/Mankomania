...
//        TextButton wurf = new TextButton("Dice", skin, "default");
        ...
        chat_image.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                ScreenManager.getInstance().switchScreen(Screen.CHAT,GameController.getClient(), Screen.MAIN_GAME);
            }
        ...
        dice_image.addListener(new ClickListener() {
            @Override
            public void clicked(InputEvent event, float x, float y) {
                ScreenManager.getInstance().switchScreen(Screen.DICE, GameController.getClient(), Screen.MAIN_GAME);
            }
