...
class FieldOverlayData {
    ...
    private final float columnBreakLeft = 0; //0 - 2 * COLUMN_WIDTH; //0 - 2 * COLUMN_WIDTH; // positons where the fields start and stop (a bit outside of the screen, so updating is invisbile)
